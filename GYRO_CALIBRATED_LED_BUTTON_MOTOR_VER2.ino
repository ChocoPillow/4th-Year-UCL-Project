...
// Motor Control
const int PWM_HALF_SPEED = 0;  // 50% speed
...
void loop() {
    ...
    bool rollExceeded = AngleRoll > angleThreshold || AngleRoll < -angleThreshold;
    bool pitchExceeded = AnglePitch > angleThreshold || AnglePitch < -angleThreshold;
